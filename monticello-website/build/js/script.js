...
var input = jquery__WEBPACK_IMPORTED_MODULE_6___default()('.validate-input .input');
jquery__WEBPACK_IMPORTED_MODULE_6___default()('.validate-form').on('submit', function () {
  var check = true;
...
jquery__WEBPACK_IMPORTED_MODULE_6___default()('.validate-form .input').each(function () {
  jquery__WEBPACK_IMPORTED_MODULE_6___default()(this).focus(function () {
    hideValidate(this);
  });
});

function validate(input) {
  if (jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).attr('type') == 'email' || jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).attr('name') == 'email') {
    if (jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).val().trim().match(/^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{1,5}|[0-9]{1,3})(\]?)$/) == null) {
      return false;
    }
  } else {
    if (jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).val().trim() == '') {
      return false;
    }
  }
}
...
function showValidate(input) {
  var thisAlert = jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).parent();
  jquery__WEBPACK_IMPORTED_MODULE_6___default()(thisAlert).addClass('alert-validate');
}

function hideValidate(input) {
  var thisAlert = jquery__WEBPACK_IMPORTED_MODULE_6___default()(input).parent();
  jquery__WEBPACK_IMPORTED_MODULE_6___default()(thisAlert).removeClass('alert-validate');
}
...
/* harmony import */ var _lib_createNews__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/createNews */ "./src/js/lib/createNews.js");
...
/***/ 0:
/*!******************************************************************************!*\
  !*** multi ./src/js/script.js ./src/js/slider.js ./src/js/lib/createNews.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! B:\VSC\1-front-end\students\buzyl_nazar\architecture\src\js\script.js */"./src/js/script.js");
__webpack_require__(/*! B:\VSC\1-front-end\students\buzyl_nazar\architecture\src\js\slider.js */"./src/js/slider.js");
module.exports = __webpack_require__(/*! B:\VSC\1-front-end\students\buzyl_nazar\architecture\src\js\lib\createNews.js */"./src/js/lib/createNews.js");
